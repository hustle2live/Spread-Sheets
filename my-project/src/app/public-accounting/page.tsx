...
const data: DadaType = [
   ...
   },
   {
      ...
      text: 'До цієї таблички слід вносити дані про рух грошових коштів по касі та банківських рахунках. <br />Поле "Тип опер." - це умовне позначення яке допомагає системі при формуванні звітів. Поля "Рах. №" та "Дата" призначені для реєстрації вхідних рахунків від сторонніх організацій і не є обов&apos;язковими, а лише інформаційними. '
   },
   {
      ...
      <div className='pb-32 bg-body-primary'>
         <div className='py-32'>
            ...
            <p className='text-center m-auto mt-4 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8 w-1/2'>
               ...
               гаражного кооперативу). Це особливо актуально на фоні росту громадських формувань, клубів та інших
               об&apos;єднань громадян. В таких організаціях на перший план виходить облік членських внесків та інших
         ...
         <div className='container mx-auto'>
            ...
            <div className='bg-transparent flex flex-col items-center text-center pb-16'>
               ...
               <ul className='text-start w-4/5 gap-4 flex flex-col list-disc'>
                  <p className='mb-4'>
                     Створивши такий набір таблиць та налагодивши їх зв&apos;язки, Ви отримуєте можливість побудувати
                     зручну і зрозумілу для себе систему обліку. Для повного розуміння можливості користування такою
                     системою я зауважу декілька важливих моментів із своєї практики:
                  </p>
                  <li>
