...
// import PdfReactViewer from '@/components/features/pdfViewerDynamic';
...
const TablesGrid: React.FC = () => {
   ...
   return (
      <div id='content' className='container m-auto bg-transparent flex flex-col items-center p-4 lg:p-6 pb-20 mt-20'>
         <h2 className='my-4 font-semibold text-gray-900 text-2xl ps-6'>Приклади таблиць</h2>
         <div className='container mt-12 grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-16 lg:px-24'>
               ...
               return (
                  ...
                  >
                     <div className='card-view h-60 relative overflow-hidden'>
                        {/* <PdfReactViewer url={item.fileUrl} /> */}
